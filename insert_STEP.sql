...
Insert into STEP values(1,'Primer Paso','%personaje% está en el inicio del Bosque Maldito,
 Donde se encuentra 3 caminos ... ¿por donde irá?','LaMaquinita',sysdate(),null,null,false,1); 
...
Y no sobrevives a la caida. FIN','Edu',sysdate(),null,null,false,1);
...
¿Que haces?','Edu',sysdate(),null,null,false,1);
...
Insert into STEP (Name,Description,usuariocreacion,fechacreacion,usuariomodificacion,fechamodificacion,final_step,id_adventures) values ('Paso2(3)','%personaje% está en el inicio del Bosque Maldito,
 Donde se encuentra 3 caminos ... ¿por donde irá?','Edu',sysdate(),null,null,false,1);
...
A tu nueva aliada, y te embarcas en una nueva aventura. FIN.','Edu',sysdate(),null,null,true,1);
